...
The goal of this analysis was to evaluate conversion performance, consultant productivity, destination popularity and enquiry trends over time.
...
•	Views per active user increased slightly from 5.21 to 5.32

•	The Average engagement time per active use increased slightly from 2m 04s to 2m 06s.

•	The Event count decreased from 300,713 to 269,691.
